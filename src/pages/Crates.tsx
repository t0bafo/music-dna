...
import { Music, Loader2, Plus, Home as HomeIcon, Brain, ListMusic, SlidersHorizontal, Package } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 lg:px-8 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4 lg:gap-6">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              ...
              <Link to="/intelligence" className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary/50 transition-colors">
                <Brain className="w-4 h-4" /><span>Intelligence</span>
              </Link>
