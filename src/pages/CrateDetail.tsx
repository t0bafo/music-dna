  ...
  return (
    <div className="min-h-screen gradient-bg pb-24 lg:pb-0">
      ...
      <Dialog open={showShareModal} onOpenChange={setShowShareModal}>
        <DialogContent className="sm:max-w-[450px] bg-card/95 backdrop-blur-xl">
          <DialogHeader>
          ...
          <div className="space-y-4 mt-2">
            ...
            <div className="flex gap-2">
              <div className="flex-1 bg-secondary/50 rounded-lg px-3 py-2 text-sm text-muted-foreground truncate border border-border/50">
                {shareUrl}
              </div>
              <Button
