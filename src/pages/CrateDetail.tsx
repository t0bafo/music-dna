        ...
        <DialogContent className="w-[95vw] max-w-[600px] bg-card/95 backdrop-blur-xl">
          ...
          <div className="space-y-4 mt-2">
            ...
            <div className="flex gap-2 items-center">
              <div 
                className="flex-1 bg-secondary/50 rounded-lg px-3 py-2.5 text-[13px] text-muted-foreground border border-border/50 overflow-x-auto overflow-y-hidden whitespace-nowrap scrollbar-thin scrollbar-thumb-primary/30 scrollbar-track-secondary/30"
              ...
              <Button
                ...
                className={`gap-2 shrink-0 min-w-[100px] ${linkCopied ? 'bg-primary text-primary-foreground' : ''}`}
              >
                {linkCopied ? (
                  <>
